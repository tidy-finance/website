...
```{python, eval = TRUE}
factors_ff3_monthly = pd.read_parquet("data/factors_ff3_monthly.parquet").add_prefix("factor_ff_")

factors_q_monthly = pd.read_parquet("data/factors_q_monthly.parquet").add_prefix("factor_q_")

macro_predictors = pd.read_parquet("data/macro_predictors.parquet").add_prefix("macro_")

industries_ff_monthly = (pd.read_parquet("data/industries_ff_monthly.parquet")
