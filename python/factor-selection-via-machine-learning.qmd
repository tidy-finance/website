...
@fig-1401 provides summary statistics for the `{python} len(industries_ff_monthly["industry"].value_counts())` monthly industry excess returns in percent. One can see that the dispersion in the execess returns varies widely across industries. \index{Graph!Box plot}
...
#| label: fig-1405 
#| fig-height: 7
#| fig-cap: "The figure shows selected variables for different industries. Grey areas indicate that the estimated Lasso regression coefficient is not set to zero. White fields show which variables get assigned a value of exactly zero."
