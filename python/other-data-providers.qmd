...
| Global factor data | Provides return data for characteristic-managed portfolios worldwide. Available at jkpfactors.com. | |
| Open Source Asset Pricing | Offers return data for over 200 trading strategies. Available at openassetpricing.com/data. | partly through `pyanomaly` |
...
| TAQ | Provides trades and quotes data for NYSE, Nasdaq, and regional exchanges. Available via WRDS Postgres. | `requests` |
