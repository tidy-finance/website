...
```{python}
print(evaluate_portfolio(weights_crsp))
```
...
print(pd.DataFrame(optimal_theta.x,
...
permutations = product(data, objective_measure,
...
print(performance_table[column_names])
``` 
