...
This appendix contains code to clean enhanced TRACE with Python. It is also available via the following Github [gist](https://gist.githubusercontent.com/patrick-weiss/86ddef6de978fbdfb22609a7840b5d8b).\index{Github!Gist} Hence, you could also source the file with the following chunk.
