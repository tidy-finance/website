...
permno_groups = (crsp_monthly
  .query("permno >= 10066 & permno <= 10100")
...
crsp_daily = (pd.read_sql_query(
    sql="SELECT permno, month, date, ret_excess FROM crsp_daily WHERE permno >= 10066 AND permno <= 10100",
    con=tidy_finance,
    parse_dates={"month": {"unit": "D","origin": "unix"},
...
beta_daily = (
  ...
  .dropna()
  .rename(columns={"beta_daily": "beta"})
)
```
