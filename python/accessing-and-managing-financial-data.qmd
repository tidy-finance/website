...
if not os.path.exists("data"):
  os.makedirs("data")
>>>>>>> 3c8d547004e01d75cc030213163ba4dd4b9263b5
```
...
Now, if we want to have the whole table in memory, we need to call `pd.read_parquet()` with the corresponding query. You will see that we regularly load the data into the memory in the next chapters.\index{Database!Read}

```{python}
<<<<<<< HEAD
pd.read_parquet("data-python/factors_ff3_monthly.parquet")
=======
pd.read_parquet("data/factors_ff3_monthly.parquet")
>>>>>>> 3c8d547004e01d75cc030213163ba4dd4b9263b5
```
...
for key, value in data_dict.items():
    value.to_parquet("data/"+key+".parquet")
```
