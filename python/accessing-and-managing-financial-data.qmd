...
`ssl` module when retrieving the $q$-factors directly from the web, as demonstrated in [Introduction to Tidy Finance](introduction-to-tidy-finance.qmd). This method should be used with caution, which is why we restore the default settings immediately after successfully downloading the data.
