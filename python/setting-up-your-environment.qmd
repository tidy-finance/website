...
There are many ways to install a Python interpreter and environments on your system. We present two ways that we found most convenient to write the book and maintain the website: (i) Installation via Anaconda along with using Python in Spyder and (ii) installation via RStudio. 
