...
polluting_industries = [49, 13, 45, 29, 28, 33, 40, 20,
...
<<<<<<< HEAD
  .iloc[:50000, :]
=======
>>>>>>> 116aa1fb11613dc346d291566fc5c827f6b055b7
  .query("rptd_pr > 25")
...
model_without_fe_coefs = (
  ...
  .assign(ci_up = lambda x: x["estimate"] + np.sqrt(2) * x["std_error"],
          ci_low = lambda x: x["estimate"] - np.sqrt(2) * x["std_error"])
)
...
polluter_plot = (
    ...
    + geom_vline(aes(xintercept=treatment_date
                     - pd.tseries.offsets.MonthBegin()), linetype="dashed")
