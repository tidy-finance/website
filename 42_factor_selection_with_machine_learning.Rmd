...
Figure 14.1 provides summary statistics for the `r industries_ff_monthly |> count(industry) |> nrow()` monthly industry excess returns in percent.\index{Graph!Box plot}
