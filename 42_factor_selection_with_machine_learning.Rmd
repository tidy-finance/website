...
The figure below provides summary statistics for the `r industries_ff_monthly |> count(industry) |> nrow()` monthly industry excess returns in percent.\index{Graph!Boxplot}
