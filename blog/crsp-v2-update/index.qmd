...
You can read all about how to connect to WRDS and download the CRSP data in our chapter **WRDS, CRSP, and Compustat** in the [R version](../../chapters/wrds-crsp-and-compustat.qmd) and the [Python version](../../chapters/wrds-crsp-and-compustat.qmd).
...
We do not repost the new routines for downloading the data in this blog. Instead, we ask you to check out the new code in the respective chapter on **WRDS, CRSP, and Compustat** in the [R version](../../chapters/wrds-crsp-and-compustat.qmd) and the [Python version](../../chapters/wrds-crsp-and-compustat.qmd).
