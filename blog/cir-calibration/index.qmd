...
### CIR Model - Overview
The CIR model aims to capture the dynamics of interest rates, offering a powerful alternative to the, already cited, Vasicek model. 
