...
Note that we use the suffix `tv_` for every object generated using `tidyverse` syntax. This way you can execute the entire code of this blog post without overwriting `data.table` objects with the `dtplyr` equivalent and vice versa. 
