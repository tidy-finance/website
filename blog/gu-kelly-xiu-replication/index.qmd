...
ml_portfolios <- oos |>
  group_by(month) |>
  mutate(
    portfolio = tidyfinance::assign_portfolio(
...
TODO: evaluation in terms of Predicted return Average return SD SR for the 10 portfolios + 10-1 (Pred Avg SD SR)
...
hml_portfolio <- ml_portfolios |> 
 summarise("H-L" = ret_excess[portfolio == min(portfolio)] -
                   ret_excess[portfolio == max(portfolio)])
