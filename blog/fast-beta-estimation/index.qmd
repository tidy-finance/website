...
As in the chapter, we combine monthly CRSP returns with the market excess returns from the Fama-French data library, both stored in the Parquet files introduced in WRDS, CRSP, and Compustat ([R](../../chapters/wrds-crsp-and-compustat.qmd) / [Python](../../chapters/wrds-crsp-and-compustat.qmd)).
