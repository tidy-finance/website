...
```{r, fig311, fig.cap = "Monthly beta estimates for example stocks using 5 years of data.", fig.alt = "Time series of beta estimates based on 5 years of monthly data for Apple, Berkshire Hathaway, Microsoft, and Tesla."}
...
```{r, fig312, fig.cap = "Box plots of average firm-specific beta estimates by industry.", fig.alt = "Box plots of average firm-specific beta estimates by industry."}
crsp_monthly |>
...
```{r, fig313, fig.cap = "Monthly deciles of estimated betas.", fig.alt = "Time series of deciles of estimated betas to illustrate the distribution of betas over time."}
beta_monthly |>
  drop_na(beta_monthly) |>
  group_by(month) |>
  summarize(
...
```{r, fig314, fig.cap = "Comparison of beta estimates using 5 years of monthly and 3 months of daily data.", fig.alt = "Time series of beta estimates using 5 years of monthly versus 3 years of daily data for Apple, Berkshire Hathaway, Microsoft, and Tesla."}
beta <- beta_monthly |>
...
```{r, fig315, fig.cap = "End-of-year share of securities with book equity values by exchange.", fig.alt = "Time series with end-of-year shares of securities with book equity values by exchange from 1960 to 2020."}
