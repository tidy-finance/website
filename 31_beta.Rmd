...
```{r, fig312, fig.cap = "The Box plots indicate the average firm-specific beta estimates by industry. Dots indicate outliers outside the 2.5 and 97.5 percent quantiles.", fig.alt = "Title: Box plots of average firm-specific beta estimates by industry. The figure shows boxplots for each of the industry. Firms with the highest average CAPM beta belong to the Public administration industry. Firms from the utility sector have the lowest average CAPM beta. The figure indicates very few outliers with negative CAPM betas. The large majority of all stocks has CAPM betas between 0.5 and 1.5."}
crsp_monthly |>
...
```{r, fig315, fig.cap = "End-of-year share of securities with book equity values by exchange.", fig.alt = "Title: End-of-month share of securities with beta estimates. The figure shows a time series with end-of-year shares of securities with book equity values by exchange from 1960 to 2020. There is almost no missing data for the estimates based on daily data. For the beta estimates based on monthly data , around 75 percent of all stock-month combinations provide sufficient long historical periods to estimate the CAPM beta."}
