...
aliases:
  ...
  - ../r/value-and-bivariate-sorts.html
  - ../python/value-and-bivariate-sorts.html
metadata:
...
The resulting monthly value premium is `{r} round(reticulate::py$value_premium * 100, 2)` percent with an annualized return of `{r} round(((1 + reticulate::py$value_premium)^12 - 1) * 100, 1)` percent.
...
The monthly value premium from dependent sorts is `{r} round(reticulate::py$value_premium * 100, 2)` percent, which translates to an annualized premium of `{r} round(((1 + reticulate::py$value_premium)^12 - 1) * 100, 1)` percent per year.
