...
metadata:
  pagetitle: Proofs
  description-meta: Mathematical proofs underlying the optimal portfolio choice results used throughout Tidy Finance with R and Python.
aliases:
  - ../proofs.html
  - ../r/proofs.html
  - ../python/proofs.html
...
Next, the two constraints ($\omega'\iota = 1 \text{ and } \omega'\mu \geq \bar{\mu}$) imply $$
\begin{aligned}
