...
This appendix contains code to clean enhanced TRACE bond transaction data.\index{Data!TRACE} We need this function in [TRACE and FISD](../r/trace-and-fisd.qmd) to download and clean enhanced TRACE trade messages following @Dick2009 and @Dick2014 for enhanced TRACE specifically. Relatedly, WRDS provides SAS code to clean enhanced TRACE data.
