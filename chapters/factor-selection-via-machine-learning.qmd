...
@fig-1401 provides summary statistics for the `{python} industries_ff_monthly["industry"].n_unique()` monthly industry excess returns in percent. One can see that the dispersion in the excess returns varies widely across industries. \index{Graph!Box plot}
