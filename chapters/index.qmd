...
title: "Tidy Finance"
aliases:
  # URLs of the removed changelog chapter (#302) redirect to the preface
  - ../changelog.html
  - ../r/changelog.html
  - ../python/changelog.html
  - changelog.html
...
We are grateful for any kind of feedback on *every* aspect of the book. So please get in touch with us via [christoph\@tidy-finance.org](mailto:christoph@tidy-finance.org) if you spot typos, discover any issues that deserve more attention, or if you have suggestions for additional chapters and sections. Additionally, let us know if you found the text helpful. We look forward to hearing from you!
