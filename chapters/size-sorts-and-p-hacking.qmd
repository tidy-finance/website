...
aliases:
  ...
  - ../r/size-sorts-and-p-hacking.html
  - ../python/size-sorts-and-p-hacking.html
metadata:
...
To speed the computation up, we parallelize the (many) different sorting procedures, as in [Beta Estimation](beta-estimation.qmd). Finally, we report the resulting size premiums in descending order. There are indeed substantial size premiums possible in our data, in particular when we use equal-weighted portfolios.\index{Parallelization}
