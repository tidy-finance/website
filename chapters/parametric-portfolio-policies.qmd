...
aliases:
  ...
  - ../r/parametric-portfolio-policies.html
  - ../python/parametric-portfolio-policies.html
metadata:
...
$$\omega_{i,t}^+ = \frac{\max(0, \omega_{i,t})}{\sum_{j=1}^{N_t}\max(0, \omega_{j,t})}.$$
