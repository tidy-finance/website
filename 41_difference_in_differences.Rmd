...
Before we can run the first regression, we need to define the `treated` indicator, which is a product of the `post_period` (i.e., all months after the signing of the Paris Agreement) and the `polluter` indicator defined above.\index{Regression!Fixed effects} 
