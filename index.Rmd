...
This book was written in RStudio using `bookdown` [@bookdown]. The website is hosted with GitHub Pages. The complete source is [available from GitHub](www.github.com/voigtstefan/tidy_finance). 
