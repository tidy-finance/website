...
Join our mission to support reproducible finance by contributing to the [Tidy Finance Blog](blog.qmd). The blog follows our endeavors to increase transparency in financial economics and opens a new channel for you. We actively encourage the finance community to share their insights on coding.
...
>We believe that the need for precise academic writing does not stop where the code begins (*[Tidy Finance Op-Ed](blog/op-ed-tidy-finance/index.qmd)*).
