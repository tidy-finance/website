...
sidebar: false
metadata:
  pagetitle: Contribute to Tidy Finance
  description-meta: The Tidy Finance blog offers opportunities for scholars and students to publicly share their R or Python code. 
---

Join our mission to support reproducible finance by contributing to the [Tidy Finance Blog](https://blog.tidy-finance.org). The blog follows our endeavors to increase transparency in financial economics and opens a new channel for you. We actively encourage the finance community to share their insights on coding.

>We hope to inspire others to share their code publicly and take part in our journey toward more reproducible research in the future (*[Tidy Finance with R - Preface](index.qmd#why-does-this-book-exist)*)
...
>We believe that the need for precise academic writing does not stop where the code begins (*[Tidy Finance Op-Ed](https://blog.tidy-finance.org/posts/op-ed-tidy-finance/)*).
...
1. Send a proposal for your blog post to [contact\@tidy-finance.org](mailto:contact@tidy-finance.org). 
