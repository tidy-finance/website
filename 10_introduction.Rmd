...
```{r, fig105, fig.cap = "Trading volume on Dow Index versus previous day trading volume", fig.alt = "A scatterplot which shows that previous day aggregate trading volume and aggregate trading volume neatly line up along a 45 degree line. "}
volume |>
...
```{r, fig106, fig.cap = "Efficient frontier for Dow Jones constituents as asset universe", fig.alt = "Figure shows Dow Jones constituents in a mean-variance diagram. A hyperbola indicates the efficient frontier of portfolios that dominate the individual holdings in the sense that they deliver higher expected returns for the same level of volatility."}
res |>
