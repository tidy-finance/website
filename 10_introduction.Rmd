...
We see that the maximum *daily* return was around `r returns |> pull(ret) |> max() * 100` percent. Perhas not surprisingly, the daily average return is close to but slightly above 0. 
