...
```{r, fig103, fig.cap = "DOW index constituents stock prices. Prices in USD, adjusted for dividend payments and stock splits.", fig.alt = "Many time series with daily prices. General trend positive for the stocks in the DOW index."}
index_prices |>
  ggplot(aes(
    x = date,
    y = adjusted,
