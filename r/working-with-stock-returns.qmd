...
::: callout-note
You are reading **Tidy Finance with R**. You can find a similar chapter for the sibling **Tidy Finance with Python** [here](../python/introduction-to-tidy-finance.qmd).
:::
