...
crsp_monthly <- msf_db |>
  ...
  filter(primaryexch %in% c("N", "A", "Q"),
         ...
         tradingstatusflg == "A") |> 
  select(permno, mthcaldt, mthret, mthretx, shrout, mthprc, primaryexch) |> 
  inner_join(
