...
crsp_monthly <- msf_db |>
  ...
  filter(date >= secinfostartdt & date <= secinfoenddt) |>
...
```{r}
# TODO: maybe rename AMEX to NYSE American (was acquired in 2008) to be align with WRDS and CRSP documentation
crsp_monthly <- crsp_monthly |>
