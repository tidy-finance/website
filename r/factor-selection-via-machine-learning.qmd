...
::: callout-note
You are reading **Tidy Finance with R**. You can find the equivalent chapter for the sibling **Tidy Finance with Python** [here](../python/factor-selection-via-machine-learning.qmd).
:::
...
where $r_t$ is the vector of industry excess returns at time $t$ and $\tilde f_t$ and $\tilde z_t$ are the (standardized) vectors of factor portfolio returns and macroeconomic variables
