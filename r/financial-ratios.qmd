...
fig_debt_to_asset_cross_section <-  balance_sheets_statements |> 
  ...
  labs(x = NULL, y = NULL, color = NULL,
       title = "Debt-to-Asset Ratio of Dow Index Constituents in 2023") + 
...
fig_debt_to_asset_interest_coverage <- income_statements |> 
  ...
  labs(
    ...
    title = "Debt-to-Asset Ratio vs Interest Coverage for Index Constituents"
  ) +
  theme(legend.position = "none")
...
fig_gross_margin_profit_margin <- combined_statements |> 
  ...
  labs(
    ...
    title = "Gross Margin vs Profit Margin for Dow Index Constituents for 2023"
  )  +
  theme(legend.position = "none")
