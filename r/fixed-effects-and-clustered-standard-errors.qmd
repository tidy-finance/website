...
::: callout-note
You are reading **Tidy Finance with R**. You can find the equivalent chapter for the sibling **Tidy Finance with Python** [here](../python/fixed-effects-and-clustered-standard-errors.qmd).
:::
...
compustat <- read_parquet("data-r/compustat.parquet") |>
