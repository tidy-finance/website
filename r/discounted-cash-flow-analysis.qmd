...
gdp_growth <- tibble(
  year = 2021:2030,
  gdp_growth = c(0.06055,	0.02512, 0.02887, 0.02765, 0.02153, 0.02028, 0.02120, 0.02122, 0.02122, 0.02122)
)
...
dcf_data |> 
  ...
  labs(
    x = NULL, y = NULL, color = NULL, linetype = NULL,
    title = "GDP growth and Microsoft's revenue growth and modeled forecasts between 2021 and 2030"
  )
```
