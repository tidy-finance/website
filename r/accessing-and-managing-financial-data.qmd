...
```{r}
factors_ff3_monthly |> write_parquet("data-r/factors_ff3_monthly.parquet")
```
...
```{r}
factors_ff5_monthly |> write_parquet("data-r/factors_ff5_monthly.parquet")
factors_ff3_daily |> write_parquet("data-r/factors_ff3_daily.parquet")
industries_ff_monthly |> write_parquet("data-r/industries_ff_monthly.parquet")
factors_q_monthly |> write_parquet("data-r/factors_q_monthly.parquet")
macro_predictors |> write_parquet("data-r/macro_predictors.parquet")
cpi_monthly |> write_parquet("data-r/cpi_monthly.parquet")
```
