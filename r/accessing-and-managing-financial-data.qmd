...
To automatically download and process Fama-French data, you can also use the `tidyfinance` package with `domain = "factors_ff"` and the corresponding `dataset` name, e.g.:
