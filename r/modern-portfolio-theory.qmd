...
::: {.callout-note}
You are reading **Tidy Finance with R**. You can find the equivalent chapter for the sibling **Tidy Finance with Python** [here](../python/modern-portfolio-theory.qmd).
:::
...
- Modern Portfolio Theory provides a structured approach for investors to allocate capital by balancing expected return against risk.
