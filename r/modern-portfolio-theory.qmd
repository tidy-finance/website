...
- Minimum-variance portfolio achieves lowest possible risk for given set of assets.
- Efficient portfolios maximize expected return for each level of risk.
- Analytical solutions exist for simple constraints but numerical optimization needed for complex problems.
- `PortfolioAnalytics` provides a robust interface for extending the mean-variance framework with additional constraints or alternative objectives.
