...
beta_dummy |> write_parquet("data-r/beta.parquet")
```
...
compustat_dummy |> write_parquet("data-r/compustat.parquet")
```
...
crsp_monthly_dummy |> write_parquet("data-r/crsp_monthly.parquet")
```
...
crsp_daily_dummy |> write_parquet("data-r/crsp_daily.parquet")
```
...
fisd_dummy |> write_parquet("data-r/fisd.parquet")
```
...
trace_enhanced_dummy |> write_parquet("data-r/trace_enhanced.parquet")
```
