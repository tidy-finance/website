...
```{r, fig.cap = "Portfolio weights for different risk aversion and transaction cost", fig.alt = "The figure shows four lines that indicate that rebalancing from the initial portfolio decreases for increasing transaction costs and for higher risk aversion."}
transaction_costs |>
