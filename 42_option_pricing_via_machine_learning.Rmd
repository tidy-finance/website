...
```{r, fig.cap = "Absolut prediction error in USD for the different fitted methods. The prediction error is evaluated on a sample of call options that where not used for training.", fig.alt = "Title: Prediction errors: Call option prices. The figure shows the pricing error of the different ML methods for call options for different levels of moneyness (Strike price minus stock price). The figure indicates variation across the models and across moneyness."}
