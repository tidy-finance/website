...
```{r, fig221, fig.cap = "The number of corporate bonds outstanding each quarter is from 1990 until 2018, as reported by Mergent FISD. The number of traded bonds from enhanced TRACE per quarter is from 2014 until 2016.", fig.alt = "Title:Number of bonds outstanding and traded each quarter. The figure shows a time series of outstanding bonds and bonds traded. The amount outstanding increases until 2000, when it starts decreasing. From 2010 onwards, it increases monotonically until the sample's end. On the other hand, the number of bonds traded from 2014 to 2018 represents only a fraction of roughly 60%, which does not change dramatically over the two years."}
bonds_outstanding |> 
