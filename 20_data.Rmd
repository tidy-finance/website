...
Next, we create a remote table with the monthly Fama-French factor data. We do so with the function `copy_to()`, which copies the data to our SQLite-database. Notice that we use the base R pipe placeholder `_` and a named argument to pipe  *factors_ff_monthly* to the argument *df*.
