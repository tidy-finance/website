...
Our book is close in spirit to @Regenstein2018 and  @Coqueret2020 in that we provide fully reproducible code for useful applications and methods in finance. 
...
- The main book on the `tidyverse`, @Wickham2016 is available online and for free: [R for Data Science](https://r4ds.had.co.nz/introduction.html) by Hadley Wickham and Garrett Grolemund explains the majority of the tools we use in our book. 
...
- RStudio provides a range of excellent [cheat sheets](https://www.rstudio.com/resources/cheatsheets/) with abundand information on how to use the `tidyverse` packages.
