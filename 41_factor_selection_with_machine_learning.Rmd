...
```{r, fig412, fig.cap = "The grey area corresponds to the out of sample period.", fig.alt = "Title: Monthly realized and fitted manufacturing industry risk premia. The figure shows the time series of realized and predicted manufacturing industry risk premia. The figure seems to indicate that the predictions capture most of the return dynamics. "}
