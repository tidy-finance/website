...
> **NOTE:**
>
> You are reading **Tidy Finance with Python**. You can find the equivalent chapter for the sibling **Tidy Finance with R** [here](../r/financial-statement-analysis.llms.md).

Financial statements and ratios are fundamental tools for understanding and evaluating companies. While we discuss how assets are priced in equilibrium in the previous chapter on the [Capital Asset Pricing Model](../python/capital-asset-pricing-model.llms.md), this chapter examines how investors and analysts assess companies using accounting information. Financial statements serve as the primary source of standardized information about a company’s operations, financial position, and performance. Their standardization and legal requirements make them particularly valuable as all companies must file financial statements.
...
[Figure 10](#fig-411) provides a cross-sectional view of debt-to-asset ratios across all stocks in 2023.
...
[Figure 13](#fig-414) illustrates the relationship between gross margins and profit margins across all stocks.
...
[![Title: Gross and profit margins for selected stocks for 2023. The figure shows a scatter plot with gross margins on the horizontal and profit margins on the vertical axis.](financial-statement-analysis_files/figure-html/fig-414-output-1.png)](financial-statement-analysis_files/figure-html/fig-414-output-1.png "Figure 13: Gross and profit margins are based on financial statements provided through the FMP API.")
...
[Figure 14](#fig-415) compares Microsoft, Apple, and Amazon’s rankings across four key financial ratio categories among all stocks. Rankings closer to 1 indicate better performance within each category.
