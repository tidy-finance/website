...
Throughout the book, we refer to the corresponding features of the `tidyfinance` package. If you want to get an overview of the existing functionality, we suggest the [PyPI page](https://pypi.org/project/tidyfinance/) that discuss specific releases and new features.
