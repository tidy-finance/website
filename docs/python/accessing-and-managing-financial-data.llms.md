...
> **NOTE:**
>
> You are reading **Tidy Finance with Python**. You can find the equivalent chapter for the sibling **Tidy Finance with R** [here](../r/accessing-and-managing-financial-data.llms.md).
...
5.  Select the right data table from the file and import the table into Python
6.  Clean the dates, scale the returns, fix column names, handle missing values, etc.
