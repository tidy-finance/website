...
> **NOTE:**
>
> You are reading **Tidy Finance with Python**. You can find the equivalent chapter for the sibling **Tidy Finance with R** [here](../r/modern-portfolio-theory.llms.md).
...
[![Title: Expected returns and volatilities of Dow Jones index constituents. The figure is a scatter plot with volatilities on the horizontal and expected returns on the vertical axis.](modern-portfolio-theory_files/figure-html/fig-201-output-1.png)](modern-portfolio-theory_files/figure-html/fig-201-output-1.png "Figure 1: Expected returns and volatilities based on monthly returns adjusted for dividend payments and stock splits.")
...
[![Title: Variance-covariance matrix of Dow Jones index constituents. The figure shows 900 tiles with variances and covariances between each constituent-pair.](modern-portfolio-theory_files/figure-html/fig-203-output-1.png)](modern-portfolio-theory_files/figure-html/fig-203-output-1.png "Figure 2: Variances and covariances based on monthly returns adjusted for dividend payments and stock splits.")
...
where \\\iota\\ is a vector of 1’s and \\\Sigma^{-1}\\ is the inverse of the variance-covariance matrix \\\Sigma\\. See [Proofs](../python/proofs.llms.md) in the Appendix for details on the derivation. In the following code chunk, we calculate the weights of the minimum-variance portfolio:
...
where \\\lambda^\* = 2\frac{\bar\mu - D/C}{E-D^2/C}\\, \\C = \iota'\Sigma^{-1}\iota\\, \\D=\iota'\Sigma^{-1}\mu\\, and \\E=\mu'\Sigma^{-1}\mu\\. For details, we again refer to the [Proofs](../python/proofs.llms.md) in the Appendix.
...
[![Title: Efficient frontier constructed from historical data for Dow Jones index constituents. The figure shows Dow index constituents in a mean-variance diagram. A hyperbola indicates the efficient frontier of portfolios that dominate the individual holdings in the sense that they deliver higher expected returns for the same level of volatility.](modern-portfolio-theory_files/figure-html/fig-206-output-1.png)](modern-portfolio-theory_files/figure-html/fig-206-output-1.png "Figure 5: The big dots indicate the location of the minimum-variance and the efficient portfolio that delivers three times the expected return of the minimum-variance portfolio, respectively. The small dots indicate the location of the individual constituents.")
