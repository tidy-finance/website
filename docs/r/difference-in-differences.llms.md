...
> **NOTE:**
>
> You are reading **Tidy Finance with R**. You can find the equivalent chapter for the sibling **Tidy Finance with Python** [here](../python/difference-in-differences.llms.md).
...
2.  Based on the exercise on ratings in [TRACE and FISD](../r/trace-and-fisd.llms.md), include ratings as a control variable in the analysis above. Do the results change?
