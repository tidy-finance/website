...
> **NOTE:**
>
> You are reading **Tidy Finance with R**. You can find the equivalent chapter for the sibling **Tidy Finance with Python** [here](../python/setting-up-your-environment.llms.md).
...
This version of the book was built with R ([R Core Team 2022](#ref-R-base)) version 4.4.1 (2024-06-14, Race for Your Life) and the following packages:
