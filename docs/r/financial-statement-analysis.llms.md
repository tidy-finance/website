...
> **NOTE:**
>
> You are reading **Tidy Finance with R**. You can find the equivalent chapter for the sibling **Tidy Finance with Python** [here](../python/financial-statement-analysis.llms.md).

Financial statements and ratios are fundamental tools for understanding and evaluating companies. While we discuss how assets are priced in equilibrium in the previous chapter on the [Capital Asset Pricing Model](../r/capital-asset-pricing-model.llms.md), this chapter examines how investors and analysts assess companies using accounting information. Financial statements serve as the primary source of standardized information about a company’s operations, financial position, and performance. Their standardization and legal requirements make them particularly valuable as all companies must file financial statements.
...
[Figure 10](#fig-411) provides a cross-sectional view of debt-to-asset ratios across our stock sample in 2023.
...
[Figure 14](#fig-415) compares Microsoft, Apple, and Amazon’s rankings across four key financial ratio categories among our stock sample. Rankings closer to 1 indicate better performance within each category.
