...
For the precise signatures and the latest changes, consult the [package changelog](../r/changelog.llms.md) and the function reference on the [package website](https://tidy-finance.github.io/r-tidyfinance/). The following blog posts walk through earlier releases and the design of the data-download interface:
