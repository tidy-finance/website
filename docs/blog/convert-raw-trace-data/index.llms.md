...
**The comparison** of the columns and column names of academic and enhanced data in [Table 1](#tbl-comparison) reveals that they are not identical but resemble strongly.
...
[Table 2](#tbl-finaltable) explains the fields of the final table. Capitalized columns are carried over from the original data, and lowercase columns denote variables used in the code available through the functions used to clean and process the data.
