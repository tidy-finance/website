...
> **NOTE:**
>
> If you want to see the Python code to generate the dummy data, check out the chapter in the appendix of our book: [WRDS Dummy Data](../../python/wrds-dummy-data.llms.md).
