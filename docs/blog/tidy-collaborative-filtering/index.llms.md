...
For this post, we rely on the `tidyverse` ([Wickham et al. 2019](#ref-Wickham2019)) family of packages, `scales` ([Wickham and Seidel 2022](#ref-scales)) for scale functions for visualization, and `recommenderlab`[^2] - a package that provides an infrastructure to develop and test collaborative filtering recommender algorithms.
...
[![Title: ROC curves of stock recommender algorithms. The figure shows that the association rules mining algorithm achieves the highest true positive rate for any false positive rate.](index_files/figure-html/unnamed-chunk-9-1.png)](index_files/figure-html/unnamed-chunk-9-1.png)
...
[![Title: Precision-Recall curves of stock recommender algorithms. The figure shows that the association rules mining algorithm achieves the highest precision for any level of recall.](index_files/figure-html/unnamed-chunk-10-1.png)](index_files/figure-html/unnamed-chunk-10-1.png)
...
[^1]: Ricci, F, Rokach, L., Shapira, B. and Kantor, P. (2011). “Recommender Systems Handbook”. <https://link.springer.com/book/10.1007/978-0-387-85820-3>.

[^2]: Hahsler, M. (2022). “recommenderlab: An R Framework for Developing and Testing Recommendation Algorithms”, R package version 1.0.3. <https://CRAN.R-project.org/package=recommenderlab>.

[^3]: Breese, J.S., Heckerman, D. and Kadie, C. (1998). “Empirical Analysis of Predictive Algorithms for Collaborative Filtering”, Proceedings of the Fourteenth Conference on Uncertainty in Artificial Intelligence, Madison, 43-52. <https://arxiv.org/pdf/1301.7363.pdf>.
