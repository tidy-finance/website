...
<a href="https://www.routledge.com/Tidy-Finance-with-R/Voigt-Weiss-Scheuch/p/book/9781032389349?utm_source=tidy-finance.org"><img src="cover_book.jpg" style="float:right" width="250" height="328"/></a>

This website is the online version of *Tidy Finance with R*, a book currently under development and intended for print release via [Chapman & Hall/CRC](https://www.routledge.com/go/chapman-hall?utm_source=tidy-finance.org). The book is the result of a joint effort of [Christoph Scheuch](https://christophscheuch.github.io?utm_source=tidy-finance.org), [Stefan Voigt](https://voigtstefan.me?utm_source=tidy-finance.org), and [Patrick Weiss](https://sites.google.com/view/patrick-weiss?utm_source=tidy-finance.org).
...
```{r, include = knitr::is_html_output(), eval = FALSE}
@book{scheuch2023,
