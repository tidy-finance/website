...
crsp_monthly = (pd.read_parquet("data-python/crsp_monthly.parquet")
    .get(["permno", "date", "industry", "ret_excess"])
    .dropna()
)
...
|------------|----------|----------|-----------|--------------|----------|----------|
| Intercept  | 0.009920 | 0.004884 | 2.031397  | 4.271697e-02 | 0.000327 | 0.019514 |
| mkt_excess | 1.375659 | 0.107611 | 12.783639 | 8.891466e-33 | 1.164259 | 1.587059 |
...
|------|--------|------------|-------------|----------|-------------|
| 0    | 10107  | 1991-03-01 | alpha       | 0.042753 | 2.805863    |
| 1    | 10107  | 1991-03-01 | mkt_excess  | 1.414250 | 5.018872    |
| 2    | 10107  | 1991-04-01 | alpha       | 0.038412 | 2.534832    |
| 3    | 10107  | 1991-04-01 | mkt_excess  | 1.434267 | 5.115538    |
| 4    | 10107  | 1991-05-01 | alpha       | 0.039112 | 2.583179    |
| ...  | ...    | ...        | ...         | ...      | ...         |
| 3013 | 93436  | 2024-10-01 | mkt_excess  | 2.380725 | 5.489195    |
| 3014 | 93436  | 2024-11-01 | alpha       | 0.038044 | 1.593911    |
| 3015 | 93436  | 2024-11-01 | mkt_excess  | 2.451193 | 5.645665    |
| 3016 | 93436  | 2024-12-01 | alpha       | 0.039501 | 1.654410    |
| 3017 | 93436  | 2024-12-01 | mkt_excess  | 2.385599 | 5.496380    |
...
|     | permno | date       | coefficient | estimate | t_statistic |
|-----|--------|------------|-------------|----------|-------------|
| 0   | 10001  | 1991-01-01 | alpha       | 0.008016 | 1.222418    |
| 1   | 10001  | 1991-01-01 | mkt_excess  | 0.098174 | 0.813336    |
| 2   | 10001  | 1991-02-01 | alpha       | 0.007914 | 1.206700    |
| 3   | 10001  | 1991-02-01 | mkt_excess  | 0.095534 | 0.791486    |
| 4   | 10001  | 1991-03-01 | alpha       | 0.007375 | 1.122804    |
| ... | ...    | ...        | ...         | ...      | ...         |
| 225 | 93436  | 2024-10-01 | mkt_excess  | 2.380725 | 5.489195    |
| 226 | 93436  | 2024-11-01 | alpha       | 0.038044 | 1.593911    |
| 227 | 93436  | 2024-11-01 | mkt_excess  | 2.451193 | 5.645665    |
| 228 | 93436  | 2024-12-01 | alpha       | 0.039501 | 1.654410    |
| 229 | 93436  | 2024-12-01 | mkt_excess  | 2.385599 | 5.496380    |

4268612 rows × 5 columns
...
for j in range(1, batches + 1):
    ...
    results = Parallel(n_jobs=n_cores)(
        delayed(
            lambda name, group: roll_capm_estimation(group, min_obs=min_obs).assign(
                permno=name
            )
        )(name, group)
...
``` python
beta.to_parquet("data-python/beta.parquet")
```
...
|-------------|-----------|------|------|-------|------|------|------|-------|
| return_type |           |      |      |       |      |      |      |       |
| daily       | 2170727.0 | 0.8  | 0.49 | -3.67 | 0.42 | 0.76 | 1.12 | 4.74  |
| monthly     | 2134306.0 | 1.1  | 0.70 | -9.02 | 0.64 | 1.04 | 1.47 | 10.35 |
